...
public sealed class ElectricalParameterCheckerTests
{
    ...
    [Fact]
    public void –¢’m‚Ì—\–ñŒê‚Í\‘¢ŒŸØ‚ğƒXƒLƒbƒv‚·‚é()
    {
        // yCŒ´“Tzfyak_tbl ‚É–¢“o˜^‚Ì—\–ñŒê‚Í\‘¢ŒŸØ‚ğƒXƒLƒbƒv(C# ‘¤‚Å–¢ˆÚA/–¢’m‚ÌŒê)B
        // fyak_tbl ‚Ì‘S—\–ñŒê(PT/BP ŠÜ‚Ş)‚Íû˜^Ï‚İ‚Ì‚½‚ßA‚±‚±‚Å‚Í fyak_tbl ŠO‚Ì‰Ë‹óŒê‚ÅŠm”F‚·‚éB
    ...
    [Fact]
    public void PTBP‚Í‹óƒpƒ‰ƒ[ƒ^‚Å³íI—¹‚·‚é()
    {
        // yCŒ´“Tzft_pt/ft_bp ‚Í‹ó‹L† len25 ƒvƒŒ[ƒXƒzƒ‹ƒ_B‹óƒpƒ‰ƒ[ƒ^‚ÍŒŸØƒ‹[ƒv”ñÀs‚Å 0B
    ...
    [InlineData("PT")]
    [InlineData("BP")]
    public void PTBP‚Í”ñ‹óƒpƒ‰ƒ[ƒ^‚ÅFY699E(string yoyaku)
    {
        // yCŒ´“Tzft_pt/ft_bp ‚Ì‹L†‚Í‹ó•¶š‚Ì‚½‚ßÀ‹L†("P")‚Æˆê’v‚¹‚¸A
        // Check_1_Group ‚Ì‹L†ŒŸõ‚Å•sˆê’v ¨ FY-699E(‹ó•\‚Æ“¯ˆê‹““®)B
