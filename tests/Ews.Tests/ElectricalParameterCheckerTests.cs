...
public sealed class ElectricalParameterCheckerTests
{
    ...
    [Fact]
    public void TR‚Íê—pƒp[ƒT‚Ö•ªŠò‚µ–{ƒtƒF[ƒY‚ÍƒXƒLƒbƒv()
    {
        // yCŒ´“TzParm_Check_Main: strcmp(s_yoyaku,"TR")==0 ¨ TR_check_main(E.2‚ÅˆÚA)
    ...
    {
        // –{ƒtƒF[ƒY–¢û˜^‚Ì’èŠiƒL[•\‚ÍƒXƒLƒbƒv(Œã‘±ƒtƒF[ƒY‚Å’Ç‰Á)
    ...
    [Fact]
    public void –¢û˜^Œ^‚Í\‘¢ŒŸØ‚Ì‚İ‚Å’l‚ÍŠi”[‚³‚ê‚È‚¢()
    {
        // MMCB ‚Í’èŠiƒL[•\û˜^Ï‚İ‚¾‚ª key_check –¢û˜^ ¨ \‘¢ŒŸØ‚Ì‚İ
