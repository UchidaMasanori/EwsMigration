...
public sealed class SecondaryParameterSetterTests
{
    ...
    [Fact]
    public void SetParam_ep2_VTは計器1次電圧をV1に設定しV2は110固定にする()
    {
        MainCircuitData vt = NewData();
        vt.ReservedWord = "VT";
    ...
    [Fact]
    public void SetParam_ep2_VTは以降の連続する回路要素4に計器1次電圧を伝播する()
    {
        MainCircuitData vt = NewData();
        vt.ReservedWord = "VT";
        vt.CircuitVoltage[0] = "210";
        ...
        MainCircuitData follower = NewData(); // 直後の kiryoso=='4'
        follower.ReservedWord = "VM";
        follower.CircuitElement = '4';

        MainCircuitData other = NewData(); // kiryoso!='4' で伝播打ち切り
