...
| 指標 | 現在値 | 総量/目標 |
|---|---|---|
| テスト成功数 | **1781** | 0 失敗 / 0 スキップを維持 |
| 移植エントリ数（name-mapping.csv 行数） | **695** | — |
| 推定移植率（libfysek.a ~110k + libfysgy.a ~67k ≒ 177k 行） | **~14〜17%** | 100% |
| 直近コミット | `MRANKUPHASH` | Fyss14 の周辺設定段のうちグループ親データ追番リセット Main_Rank_Update を GroupParentSequenceResetter として移植。階層番号 000 の後に続く階層 001 要素を探し、同一系統内で階層 001 ・並列追番≠001・グループ並列追番≠000・系統種別 1 の要素数が 0 件の時のみ、同系統の階層 001・系統種別 1 の全要素へ goyano="000" を設定する。テスト+5 |
| 最終更新 | 2026-08-06 | — |
