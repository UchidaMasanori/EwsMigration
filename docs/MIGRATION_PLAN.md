...
| 直近コミット | `edef139` | Fyss14 の周辺設定段のうちグループ親データ追番リセット Main_Rank_Update を GroupParentSequenceResetter として移植。階層番号 000 の後に続く階層 001 要素を探し、同一系統内で階層 001 ・並列追番≠001・グループ並列追番≠000・系統種別 1 の要素数が 0 件の時のみ、同系統の階層 001・系統種別 1 の全要素へ goyano="000" を設定する。テスト+5 |
| 最終更新 | 2026-08-06 | — |
