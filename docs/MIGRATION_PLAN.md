...
| 直近コミット | `1805a18` | Fyss14 SetParam_ep2(list版) に PLTR を追加(SetParam_ep2_RTR_V1)。親(RTRなら更にその親)の回路電圧 kv0 で 1 次側電圧 V1[0] を決定(>105->200/以下->100/PLTRかつ>=380->400)し VC 区分に計器 1 次側電圧区分を設定 |
| 最終更新 | 2026-08-06 | — |
