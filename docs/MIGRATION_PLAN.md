...
| 指標 | 現在値 | 総量/目標 |
|---|---|---|
| テスト成功数 | **1659** | 0 失敗 / 0 スキップを維持 |
| 移植エントリ数（name-mapping.csv 行数） | **663** | — |
| 推定移植率（libfysek.a ~110k + libfysgy.a ~67k ≒ 177k 行） | **~14〜17%** | 100% |
| 直近コミット | `HASH_PLACEHOLDER` | Fyss14 SetParam_ep2 に単一レコード完結の NHMB/CR ケースを追加(NHMB=MCB_P/V2+WまたはA2からAT算出・CR=27A/B/CでVC/CC/タイプNC/極数3桁目2)→ep[2]自己完結セッタを拡充 |
| 最終更新 | 2026-08-06 | — |
