...
| 指標 | 現在値 | 総量/目標 |
|---|---|---|
| テスト成功数 | **1428** | 0 失敗 / 0 スキップを維持 |
| 移植エントリ数（name-mapping.csv 行数） | **594** | — |
